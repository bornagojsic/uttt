...
int *input_move(int prev_player){ //Turns player imput (e.g. A8) into array of size 2 (e.g. {3, 1} (index, player) )  
...
void output_move(int move[2]){ //Inverse of input_move
...
int main(){ //Plays the game
	...
	int difficulty; //Number of iterations of MCTS algorithm
	Board game;
